...
import { fetchAllIncidents, fetchAllIncidentsByEmployeeId, fetchAllIncidentStatus, fetchAllIncidentTypes } from "@slices/IncidentSlice/incident";
...
const IncidentView = () => {
  ...
  return (
    ...
    sx={{backgroundColor:theme.palette.background.paper,padding:2,borderRadius:2,boxShadow:1}}
    width="100%" height="100%">
      ...
      <Stack width="100%" height="480px">
        <IncidentTable isIncidentModalVisible={isIncidentModalOpen} setIsIncidentModalOpen={setIsIncidentModalOpen} />
      </Stack>
