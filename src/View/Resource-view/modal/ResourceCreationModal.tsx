      ...
      title={
        <Box display="flex" justifyContent="space-between" alignItems="center">
          <Typography variant="h6">
            {resourceSlice?.selectedResource ? "Update/View" : "Add"} Resources
          </Typography>
          {resourceSlice?.selectedResource != null &&
      ...
      footer={
        <Box display="flex" justifyContent="end" width="100%">
          <Button
            variant="outlined"
            sx={{ mr: 2 }}
            onClick={() => setIsResourceModalVisible(false)}
          >
            Cancel
          </Button>
          <Button
            ...
            variant="contained"
            onClick={() =>
              document.getElementById("resource-submit-button")?.click()
            }
          >
            Save
          </Button>
