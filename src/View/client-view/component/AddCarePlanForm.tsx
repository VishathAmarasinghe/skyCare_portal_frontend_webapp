...
const AddCarePlanForm = ({
  activeStepper,
  isEditMode,
  setIsEditMode,
}: AddCarePlanFormProps) => {
  ...
  const [carePlanStatusList, setCarePlanStatusList] = useState<
    CarePlanStatus[]
  >([]);
  const [clientList, setSelectedClientList] = useState<
                  ...
                  >
                    ...
                    >
                      {clientList.map((client) => (
                        <MenuItem value={client.clientID as string}>
                        ...
                        <Grid container spacing={2} key={index}>
                          ...
                          <Grid item xs={12}>
                            <TextField
                              ...
                              onBlur={handleBlur}
                              value={values.carePlanLongTermGoals[index].notes}
                              onChange={handleChange}
                            />
                          </Grid>
                        </Grid>
