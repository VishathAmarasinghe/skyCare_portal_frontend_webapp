...
const AddNewCarePlanModal = ({
  isCarePlanAddModalVisible,
  setIsCarePlanAddModalVisible,
  isEditMode,
  setIsEditMode,
}: AddNewCarePlanModalProps) => {
      ...
      footer={
        <Box display="flex" justifyContent="end" width="100%">
          ...
          <Button
            variant="outlined"
            sx={{ mr: 1 }}
            onClick={() => setIsCarePlanAddModalVisible(false)}
          >
            Cancel
          </Button>
          <Button
          ...
          <Button
            ...
            variant="contained"
            onClick={
              activeStep === CREATE_CARE_PLAN_STEPS.length - 1
                ? handleSave
                : handleNext
            }
            disabled={
              loading ||
              (activeStep === CREATE_CARE_PLAN_STEPS.length - 1 && !isEditMode)
                ? true
                : false
