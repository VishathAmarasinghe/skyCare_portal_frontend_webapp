...
import { AppConfig, APPLICATION_ADMIN, APPLICATION_CARE_GIVER, APPLICATION_SUPER_ADMIN } from '../../config/config'
        ...
        try {
          ...
          dispatch(
            enqueueSnackbarMessage({
              message: response?.status === HttpStatusCode.Ok ? SnackMessage.success.login : '',
              type: 'success',
            })
          );
