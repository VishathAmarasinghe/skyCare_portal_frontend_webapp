...
export const fetchClientStatus = createAsyncThunk(
    ...
    async (
      ...
      return new Promise<ClientStatus[]>((resolve, reject) => {
        APIService.getInstance()
          .get(
            AppConfig.serviceUrls.clientStatus
          )
          .then((response) => {
            console.log('response', response)
            resolve(response.data)
...
export const fetchClientTypes = createAsyncThunk(
    ...
    async (
      ...
      return new Promise<ClientType[]>((resolve, reject) => {
        APIService.getInstance()
          .get(
            AppConfig.serviceUrls.clientTypes
          )
          .then((response) => {
            console.log('response', response)
            resolve(response.data)
...
export const fetchLanguages = createAsyncThunk(
    ...
    async (
      ...
      return new Promise<Language[]>((resolve, reject) => {
        APIService.getInstance()
          .get(
            AppConfig.serviceUrls.languages
          )
          .then((response) => {
            console.log('response', response)
            resolve(response.data)
...
export const SaveLanguage = createAsyncThunk(
    ...
    async (
      ...
      return new Promise<Language>((resolve, reject) => {
        APIService.getInstance()
          .post(
            AppConfig.serviceUrls.languages, Payload
          )
          .then((response) => {
            console.log('response', response)
  ...
  export const saveClassification = createAsyncThunk(
    ...
    async (
      ...
      return new Promise<ClientClassification>((resolve, reject) => {
        APIService.getInstance()
          .post(
            AppConfig.serviceUrls.classifications, Payload
          )
          .then((response) => {
            console.log('response', response)
            if(response.status === HttpStatusCode.Created){
  ...
  export const saveClientType = createAsyncThunk(
    ...
    async (
      ...
      return new Promise<ClientType>((resolve, reject) => {
        APIService.getInstance()
          .post(
            AppConfig.serviceUrls.clientTypes, Payload
          )
          .then((response) => {
            console.log('response', response)
            if(response.status === HttpStatusCode.Created){
  ...
  export const saveClientStatus = createAsyncThunk(
    ...
    async (
      ...
      return new Promise<ClientStatus>((resolve, reject) => {
        APIService.getInstance()
          .post(
            AppConfig.serviceUrls.clientStatus, Payload
          )
          .then((response) => {
            console.log('response', response)
            if(response.status === HttpStatusCode.Created){
...
const SelectorSlice = createSlice({
    ...
    extraReducers: (builder) => {
      builder
        ...
        .addCase(fetchClassifications.fulfilled, (state, action: PayloadAction<ClientClassification[]>) => {
        ...
        .addCase(fetchClientTypes.fulfilled, (state, action: PayloadAction<ClientType[]>) => {
          state.State = State.success;
        ...
        .addCase(fetchClientStatus.fulfilled, (state, action: PayloadAction<ClientStatus[]>) => {
          state.State = State.success;
        ...
        .addCase(SaveLanguage.fulfilled, (state, action: PayloadAction<Language>) => {
        ...
        .addCase(saveClassification.fulfilled, (state, action: PayloadAction<ClientClassification>) => {
          state.submitState = State.success;
        ...
        .addCase(saveClientType.fulfilled, (state, action: PayloadAction<ClientType>) => {
          state.submitState = State.success;
        ...
        .addCase(saveClientStatus.fulfilled, (state, action: PayloadAction<ClientStatus>) => {
          state.submitState = State.success;
