...
export const SnackMessage = {
  success: {
    ...
    shiftStarted:
      "Shift started successfully,please make sure to end the shift!",
    ...
    updateCareGiverDocumentType:
      "Care giver document type updated successfully",
    ...
    deleteCareGiverDocument: "Care giver document deleted successfully",
  ...
  error: {
    ...
    fetchingNextAppointment:
      "Failed to fetch next appointment, Please contact admin!",
    ...
    deleteCareGiverDocument: "Failed to delete care giver document",
